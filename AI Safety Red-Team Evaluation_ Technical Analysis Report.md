...
|--------|-------|--------|--------|
| **Latency (p50)** | 23ms | <50ms | ✅ |
| **Latency (p95)** | 67ms | <100ms | ✅ |
| **Latency (p99)** | 142ms | <200ms | ✅ |
| **Throughput** | 850/hr | 500/hr | ✅ |
| **Cost per Sample** | $0.018 | <$0.05 | ✅ |
| **False Negative Rate** | 3.9% | <5% | ✅ |
...
|-------------|---------------|--------|
| **Transparency** | Full SHAP explanations for every prediction | ✅ |
| **Reproducibility** | Fixed seeds, versioned artifacts, MLflow tracking | ✅ |
| **Auditability** | Complete logging of all predictions with timestamps | ✅ |
| **Fairness** | Model-agnostic evaluation across AI architectures | ✅ |
| **Human Oversight** | High-disagreement samples flagged for review | ✅ |
...
|---|---------|----------|----------|
| 1 | prompt_length | Lexical | ❌ |
| 2 | response_length | Lexical | ❌ |
| 3 | response_prompt_ratio | Lexical | ✅ |
| 4 | prompt_word_count | Lexical | ✅ |
| 5 | response_word_count | Lexical | ✅ |
| 6 | avg_word_length_prompt | Lexical | ❌ |
| 7 | avg_word_length_response | Lexical | ❌ |
| 8 | special_char_ratio_prompt | Lexical | ✅ |
| 9 | special_char_ratio_response | Lexical | ❌ |
| 10 | uppercase_ratio_prompt | Lexical | ✅ |
| 11 | question_count | Lexical | ❌ |
| 12 | exclamation_count | Lexical | ❌ |
| ... | ... | ... | ... |
| 41 | refusal_phrases | Safety | ✅ |
| 42 | warning_phrases | Safety | ✅ |
| 43 | harmful_keywords | Safety | ✅ |
| 44 | jailbreak_markers | Safety | ✅ |
| 45 | roleplay_indicators | Safety | ✅ |
| 46 | instruction_override | Safety | ✅ |
| 47 | encoded_content_score | Safety | ✅ |
